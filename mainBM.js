...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    try {
      ...
      const mix1 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m1, 0, './assets/audio/malay/page1.mp3');
      const mix2 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m2, 1, './assets/audio/malay/page2.mp3');
      const mix3 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m3, 2, './assets/audio/malay/page3.mp3');
      const mix4 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m4, 3, './assets/audio/malay/page4.mp3');
      const mix5 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m5, 4, './assets/audio/malay/page5.mp3');
      const mix6 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m6, 5, './assets/audio/malay/page6.mp3');
      const mix7 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m7, 6, './assets/audio/malay/page7.mp3');
      const mix8 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m8, 7, './assets/audio/malay/page8.mp3');
      const mix9 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m9, 8, './assets/audio/malay/page9.mp3');
      const mix10 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m10, 9, './assets/audio/malay/page10.mp3');
