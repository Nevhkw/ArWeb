...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    try {
      ...
      const mix4 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m4, 3, './assets/audio/english/page4.mp3');
      const mix5 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m5, 4, './assets/audio/english/page5.mp3');
      const mix6 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m6, 5, './assets/audio/english/page6.mp3');
      const mix7 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m7, 6, './assets/audio/english/page7.mp3');
      const mix8 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m8, 7, './assets/audio/english/page8.mp3');
      const mix9 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m9, 8, './assets/audio/english/page9.mp3');
      const mix10 = await setupAnchorWithAutoAnimationAndAudio(mindarThree, m10, 9, './assets/audio/english/page10.mp3');
